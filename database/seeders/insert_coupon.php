...
{
    /**
     * Run the database seeds.'code_coupon'=>"MARRYCHIRT",
     */
    public function run(): void
    {
        $coupons =[
            ...
            ["title"=>"Free Ship",'code'=>"FREESHIP423",'discount'=>20000,'max'=>3,'created_at'=>Carbon::createFromFormat('d/m/Y H:i:s','01/04/2023 00:00:00')],
            ["title"=>"Free Ship",'code'=>"FREESHIP522",'discount'=>20000,'max'=>3,'status'=>false,'created_at'=>Carbon::createFromFormat('d/m/Y H:i:s','01/05/2022 00:00:00')],
