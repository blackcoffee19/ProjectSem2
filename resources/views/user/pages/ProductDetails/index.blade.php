                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="product" id="product">
                            ...
                            <div class="zoom" onmousemove="zoom(event)"
                                style="background-image: url({{ asset('images/products/' . $id_product->libraries[3]->image) }}">
                                <!-- img -->
                                <!-- img --><img src="{{ asset('images/products/' . $id_product->libraries[3]->image) }}"
                                    alt="">
                            </div>
                            <?php endif; ?>
                            ...
                            <div>
                                <div class="zoom" onmousemove="zoom(event)"
                                    style="background-image: url({{ asset('images/products/' . $id_product->libraries[2]->image) }})">
                                    <!-- img -->
                            ...
                            <div>
                                <div class="zoom" onmousemove="zoom(event)"
                                    style="background-image: url({{ asset('images/products/' . $id_product->libraries[1]->image) }})">
                                    <!-- img -->
                            ...
                            <div>
                                <div class="zoom" onmousemove="zoom(event)"
                                    style="background-image: url({{ asset('images/products/' . $id_product->libraries[0]->image) }})">
                                    <!-- img -->
                    ...
                    <div class="col-md-6">
                        <div class="ps-lg-10 mt-6 mt-md-0">
                            <!-- content -->
                            <a href="#!" class="mb-4 d-block">{{ $id_product->typeproduct->type }}</a>
                            <!-- heading -->
                            <h1 class="mb-1">{{ $id_product->name }}</h1>
                            <div class="mb-4">
                                <!-- rating -->
                            ...
                            <div class="fs-4">
                                <!-- price --><span class="fw-bold text-dark">${{ $id_product->price }}</span> <span
                                    class="text-decoration-line-through text-muted">${{ number_format((100 * $id_product->price) / (100 - $id_product->sale), 0) }}</span><span><small
                                        class="fs-6 ms-2 text-danger">{{ $id_product->sale }}%
                                        Off</small></span>
                            </div>
                            <!-- hr -->
                            <hr class="my-6">
                            ...
                            <div>
                                ...
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($id_product->quantity > 0)
                                                    {{ number_format($id_product->quantity, 0) }}
                                                @else
                                                    Disabled
                                                @endif
                                        ...
                                        <tr>
                                            <td>Type:</td>
                                            <td>{{ $id_product->typeproduct->type }}</td>
                        ...
                        <div class="col">
                            <div class="card card-product">
                                <div class="card-body">
                                    ...
                                    <h2 class="fs-6"><a href="{{ route('userShowProduct', $product->id_product) }}"
