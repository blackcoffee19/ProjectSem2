        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-12 text-center text-md-start"><span>
                        0812 525 141 | freshshopt12206m1@gmail.com
                    </span>
                </div>
                            ...
                            <div class="list-inline me-4">
                                @if (Auth::check())
                                    <div class="list-inline-item me-3">
                                        ...
                                        <div
                                            class=" dropdown-menu dropdown-menu-end dropdown-menu-lg shadow p-0 border-0">
                                            <div
                                                class="border-bottom p-5 d-flex justify-content-between align-items-center">
                                                <div>
                                                    <h5 class="mb-1">Notifications</h5>
                                                    <p class="mb-0 small">You have {{ isset($news) ? count($news) : 0 }}
                                                        unread notificates</p>
                                                </div>
                                                ...
                                                <ul class="list-group list-group-flush notification-list-scroll fs-6">
                                                    ...
                                                    @if (isset($news))
                                                        @foreach ($news as $new)
                                                            <li
                                                                ...
                                                                @if (Auth::check() && Auth::user()->admin == '0')
                                                                    @if ($new->link == 'show_coupon')
                                                                        <a href="javascript:void(0)"
                                                                            class="text-muted modal_coupon"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#couponModal"
                                                                            data-coupon="{{ $new->attr }}">
                                                                            <div class="d-flex">
                                                                                <img src="{{ asset('images/icons/tags.svg') }}"
                                                                    ...
                                                                    @else
                                                                        <a href="{{ route($new->link, $new->attr) }}"
                                                                            class="text-muted">
                                                                            <div class="d-flex">
                                                                                <img src="{{ asset('images/products/' . $new->image) }}"
                                                                                    alt=""
                                                                ...
                                                                @else
                                                                    <a href="javascript:void(0)"
                                                                        class="text-muted manager_notificate"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#viewModalOrder2"
                                                                        data-order="{{ $new->id_news }}">
                                                                        <div class="d-flex">
                                                                            <img src="{{ asset('images/avatar/' . $new->image) }}"
                                                                                alt=""
                                                                                class="avatar avatar-md rounded-circle"
                                                                                width="40" height="40" />
                                                                            <div class="ms-4">
                                                    ...
                                                    @else
                                                        <li class="list-group-item px-5 py-4 list-group-item-action">
                                                            <h4 class="text-muted text-center">There are no notificates
                                                            </h4>
                                                        </li>
                                                    @endif
                                                </ul>
                                    ...
                                    @if (Auth::check())
                                        ...
                                        <a href="#!" class="text-muted dropdown-toggle user_dropdown "
                                            ...
                                            @if (!Auth::user()->email_verified)
                                                <img src="{{ asset('images/icons/warning.png') }}" width="18"
                                                    height="18" class=" my-auto ms-3 img-fluid rounded-circle">
                                            @endif
                                        </a>
                                ...
                                @if (Auth::check() && Auth::user()->admin == '2')
                                    <div>
                                        <a class="text-muted position-relative btn_showcart" href="#offcanvasExample"
                                            role="button" data-bs-target="#offcanvasRight"
                            ...
                            <div class="me-3">
                                ...
                                <div class=" dropdown-menu dropdown-menu-end dropdown-menu-lg shadow p-0 border-0">
                                    <div class="border-bottom p-5 d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-1">Notifications</h5>
                                            <p class="mb-0 small">You have {{ isset($news) ? count($news) : 0 }} unread
                                                notificates</p>
                                        </div>
                                        {{-- <a href="{{route('remove-allnews')}}" class="text-muted">
                                                        ...
                                                        @if (Auth::check() && Auth::user()->admin == '0')
                                                            @if ($new->link == 'show_coupon')
                                                                <a href="javascript:void(0)"
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <img src="{{ asset('images/icons/tags.svg') }}"
                                                                            class="avatar avatar-md rounded-circle ms-3"
                                                                            width="40" height="40" />
                                                                        <div class="ms-4">
                                                                            <p class="mb-1 text-dark">
                                                                                {{ $new->title }}
                                ...
                                <div class=" dropdown-menu pb-0 ">
                                    <div class="list-group">
                                        ...
                                        <a href="{{ route('accountsetting') }}"
                                            ...
                                            <span><i class="fa-solid fa-gear"></i> Setting</span>
                                            @if (!Auth::user()->email_verified)
                                                <img src="{{ asset('images/icons/warning.png') }}" width="15"
                                                    height="15" class="img-fluid rounded-circle">
                                            @endif
                                        </a>
                                        @if (Auth::user()->admin == '0')
                                            <a href="{{ route('accountaddress') }}"
        ...
        <div class="modal-content p-4">
            ...
            <div class="modal-body">
                <form action="{{ route('signin') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary" id="modal_signin" style="width: 100px"
            ...
            <a class="h4 fw-normal text-decoration-none text-center shadow p-2 rounded-pill"
                href="{{ route('google-auth') }}"
                style="vertical-align: middle;font-family: 'Montserrat', sans-serif;">
                <svg xmlns="http://www.w3.org/2000/svg" class="me-1" height="30" viewBox="0 0 24 24"
                    width="30">
                    <path
                                ...
                                <div class='row align-items-center'>
                                    <div class='col-1'>
                                        @if ($order->id_user && isset($order->User->avatar))
                                            <img src="{{ asset('images/avatar/' . $order->User->avatar) }}"
                                    ...
                                    <div class='col-2 '>
                                        ...
                                        <small
                                            class="text-muted">{{ date_format($order->created_at, 'F j Y, g:i a') }}</small>
                                    </div>
