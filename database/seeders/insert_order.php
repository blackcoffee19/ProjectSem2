...
class insert_order extends Seeder
{
    ...
    public function run(): void
    {
        $orders = [
            ...
            ['order_code'=>'GUT_2','receiver'=>"UwU",'address'=>"124 Nguyen Thi Minh Khai, Phuong Pham Ngu Lao, Quan 1, TP Ho Chi Minh",'phone'=>"01232326799",'email'=>"cattuongw2000@gmail.com",'method'=>'paypal','status'=>'unconfirmed','created_at'=>Carbon::createFromFormat('d/m/Y H:i:s',  '17/04/2023 00:00:00')],
        ];
        try {
