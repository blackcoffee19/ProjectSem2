                    ...
                    <div class="col-6 mx-auto">
                        <div class="ps-lg-10 mt-6 mt-md-0">
                            ...
                            <div class="mb-4">
                                ...
                                <a href="#"
                                    class="ms-2">({{ count($product->Comment->where('rating', '!=', null)) }}
                                    reviews)</a>
                            </div>
                            <div class="fs-4">
                                @if ($product->sale > 0)
                                            ...
                                            <table class="table table-striped">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>{{ $product->TypeProduct->type != 'meat' ? 'Vegetarian' : 'Meat' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Quantity</th>
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <span>
                                                        ...
                                                        <span class="ms-3">{{ number_format($rating2, 2, '.', ' ') }}
                                                            out
                                                            of 5</span><small
                                                            class="ms-3">{{ count($product->Comment->where('rating', '<>', null)) }}
                                                ...
                                                @if (Auth::check())
                                                    <div class="row mb-3 w-100">
                                                        <div class="col-md-2 col-lg-1">
                                                            <img src="images/avatar/{{ Auth::user()->image ? Auth::user()->image : 'user.png' }}"
                                                                alt="" class="rounded-circle" width="48px"
                                                                height="48px" style="object-fit: cover">
                                                        </div>
                                                            ...
                                                            <form action="{{ route('addComment') }}" method="post">
                                                                ...
                                                                <div class="d-flex flex-row justify-content-between">
                                                                    ...
                                                                    <input type="submit" value="Post"
                                                                        id="submit_comment" class="btn btn-primary"
                                                                        disabled>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    ...
                                                    @foreach ($comments as $cmt)
                                                        <div class="row border-bottom pb-6 mb-6">
                                                            ...
                                                            <div class="ms-5 col-8 mx-auto">
                                                                ...
                                                                <p class="small"> <span
                                                                        class="text-muted">{{ date_format($cmt->created_at, 'j F Y') }}</span>
                                                                    @if ($cmt->verified)
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        @if ($cmt->rating != null && $cmt->verified)
                                                                            <div class="form-check form-check-inline mb-3">
                                                                                ...
                                                                                <input type="radio" name="rating_cmt"
                                                                                    class="btn-check"
                                                                                    id="rating{{ $cmt->id_comment }}-btn1"
                                                                                    autocomplete="off" value="1"
                                                                                    {{ $cmt->rating == 1 ? 'checked' : '' }}>
                                                                                <label class="btn-cus text-warning"
                                                                                    for="rating{{ $cmt->id_comment }}-btn1">
                                                                                    <i
                                                                                        class="bi {{ $cmt->rating >= 1 ? 'bi-star-fill' : 'bi-star' }}"></i>
                                                                                </label>
                                                                                <input type="radio" name="rating_cmt"
                                                                                    class="btn-check"
                                                                                    id="rating{{ $cmt->id_comment }}-btn2"
                                                                                    autocomplete="off" value="2"
                                                                                    {{ $cmt->rating == 2 ? 'checked' : '' }}>
                                                                                <label class="btn-cus text-warning"
                                                                                    for="rating{{ $cmt->id_comment }}-btn2">
                                                                                    <i
                                                                                        class="bi {{ $cmt->rating >= 2 ? 'bi-star-fill' : 'bi-star' }}"></i>
                                                                                </label>
                                                                                <input type="radio" name="rating_cmt"
                                                                                    class="btn-check"
                                                                                    id="rating{{ $cmt->id_comment }}-btn3"
                                                                                    autocomplete="off" value="3"
                                                                                    {{ $cmt->rating == 3 ? 'checked' : '' }}>
                                                                                <label class="btn-cus text-warning"
                                                                                    for="rating{{ $cmt->id_comment }}-btn3">
                                                                                    <i
                                                                                        class="bi {{ $cmt->rating >= 3 ? 'bi-star-fill' : 'bi-star' }}"></i>
                                                                                </label>
                                                                                <input type="radio" name="rating_cmt"
                                                                                    class="btn-check"
                                                                                    id="rating{{ $cmt->id_comment }}-btn4"
                                                                                    autocomplete="off" value="4"
                                                                                    {{ $cmt->rating == 4 ? 'checked' : '' }}>
                                                                                <label class="btn-cus text-warning"
                                                                                    for="rating{{ $cmt->id_comment }}-btn4">
                                                                                    <i
                                                                                        class="bi {{ $cmt->rating >= 4 ? 'bi-star-fill' : 'bi-star' }}"></i>
                                                                                </label>
                                                                                <input type="radio" name="rating_cmt"
                                                                                    class="btn-check"
                                                                                    id="rating{{ $cmt->id_comment }}-btn5"
                                                                                    autocomplete="off" value="5"
                                                                                    {{ $cmt->rating == 5 ? 'checked' : '' }}>
                                                                                <label class="btn-cus text-warning"
                                                                                    for="rating{{ $cmt->id_comment }}-btn5">
                                                                                    <i
                                                                                        class="bi {{ $cmt->rating >= 5 ? 'bi-star-fill' : 'bi-star' }}"></i>
                                                                                </label>
                                                            ...
                                                            <div class="col-1 dropdown ">
                                                                <a class="dropdown-toggle commt-edit user_dropdown"
                                                                    href="#" role="button"
                                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                                ...
                                                                @if (Auth::check() && $cmt->id_user == Auth::user()->id_user)
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item edit_btn"
                                                                                ...
                                                                                aria-expanded="false"
                                                                                aria-controls="collapseEdit{{ $cmt->id_comment }}">Edit</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item"
                                                                                href="{{ route('delete_cmt', $cmt->id_comment) }}"
                                                                                onclick="return confirm('Do you want delete this comment?')">Delete</a>
                                                                        </li>
                                                                    </ul>
                                                                @endif
                                                            </div>
                            ...
                            <div class="card card-product">
                                <div class="card-body">
                                    <div class="text-center position-relative ">
                                        <div class=" position-absolute top-0 start-0">
                                            @if ($re_product->sale > 0)
                                                <span
                                                    class="badge bg-danger">{{ number_format($re_product->sale, 0) }}%</span>
                                            @endif
                                        </div>
                                        ...
                                        <div class="card-product-action">
                                            <a class="btn-action btn_modal" data-bs-toggle="modal"
                                                ...
                                                data-product="{{ $re_product->id_product }}">
                                                <i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true"
                                                    title="Quick View"></i>
                                            </a>
                                            <a class="btn-action {{ Auth::check() ? 'addFav' : '' }}"
                                                data-bs-toggle="tooltip"
                                                {{ !Auth::check() ? 'data-bs-toggle=modal data-bs-target=#userModal href=#!' : "data-bs-toggle='tooltip' data-bs-html='true' title='Wishlist' data-bs-idproduct=$re_product->id_product" }}><i
                                                    class="bi {{ Auth::check() ? (count(Auth::user()->Favourite->where('id_product', '=', $re_product->id_product)) > 0 ? 'bi-heart-fill text-danger' : 'bi-heart') : 'bi-heart' }}"></i></a>
                                            <a class="btn-action compare_product" data-bs-toggle="tooltip"
                                                data-bs-html="true" title="Compare"
                                                data-bs-product="{{ $re_product->id_product }}">
                                                <i class="bi bi-arrow-left-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <span
                                            class="text-muted small">{{ number_format($rating3, 1, '.', ' ') }}({{ count($re_product->Comment->where('rating', '<>', null)) }})</span>
                                    </div>
                                    <!-- price -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("input[name='rating_cmt']").click(function() {
                $(this).prevUntil("input.stop1").next().children().removeClass('bi-star').addClass(
                    'bi-star-fill');
                $(this).next().children().removeClass('bi-star').addClass('bi-star-fill');
                $(this).nextUntil("input.stop2").next().children().removeClass('bi-star-fill').addClass(
                    'bi-star');
            });
