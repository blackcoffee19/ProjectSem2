<script>
    $(document).ready(function() {
                ...
                $('.btn_modal').click(function() {
                    $.get(window.location.origin + "/public/index.php/ajax/modal/show-product/" + $(this).data(
                        ...
                        $("#compare_product2").click(function() {
                            ...
                            $.get(window.location.origin +
                                "/public/index.php/ajax/add-compare/" + dataProduct[
                                    'id_product'],
                                function(data) {
                ...
                $('.compare_product').click(function() {
                    ...
                    $.get(window.location.origin + "/public/index.php/ajax/add-compare/" + $(this).data(
                ...
                $('#show_compare').click(function() {
                    $.get(window.location.origin + "/public/index.php/ajax/compare/showcompare", function(
                    data) {
                ...
                $('.addFav').click(function() {
                    ...
                    $.get(window.location.origin + '/public/index.php/ajax/add-favourite/' + $(this).data(
                ...
                $('.addToCart').click(function() {
                    ...
                    @else
                        ...
                        toastorder.show();
                    @endif
                    $.get(window.location.origin + "/public/index.php/ajax/add-cart/" + $(this).data('bsId'),
                        function(data) {
                            $('.countCart').html(data);
                        });
                });
                ...
                $('.remove_add').click(function() {
                    $.get(window.location.origin + "/public/index.php/ajax/remove_address/" + $(this).data(
                        'idadd'), function(data) {
                ...
                $('input[name=register_email]').change(function() {
                    if (!valiEmail.test($(this).val())) {
                        ...
                        $.get(window.location.origin + '/public/index.php/ajax/check-email/' + $(this).val(),
                            function(data) {
                                if (data == "existed") {
                ...
                $(".modal_coupon").click(function() {
                    $.get(window.location.origin + "/public/index.php/ajax/show_coupon/" + $(this).data(
                    ...
                    $(".manager_notificate").click(function() {
                        $.get(window.location.origin +
                            "/ProjectSem2/public/manager/ajax/check-notificate/" + $(
                                this).data('order'),
                            function(data) {
                                ...
                                for (let i = 0; i < dataJson['cart'].length; i++) {
                                    ...
                                    total += parseInt(dataJson['cart'][i]['sale']) > 0 ? (parseInt(
                                        dataJson[
                                            'cart'][i]['price']) * (1 - parseInt(dataJson[
                                        'cart'][i][
                                        'sale'
                                    ]) / 100)) * (parseInt(dataJson['cart'][i]['amount']) /
                                        1000) : parseInt(dataJson['cart'][i]['price']) * (
                                        parseInt(dataJson[
                                            'cart'][i]['amount']) / 1000);
                                };
                                $('#listCart2').html(list);
                    ...
                    $('.check_order').click(function() {
                        $.get(window.location.origin + "/ProjectSem2/public/manager/ajax/check-order/" +
                            $(this)
                            .data('order'),
                            function(data) {
                                let dataJson = jQuery.parseJSON(data);
                                ...
                                $("#status_order option[value=" + dataJson['status'] + "]").attr(
                                    "selected",
                                    true);
                                if (dataJson['status'] == 'unconfirmed') {
                                    $("#status_order option[value='unconfirmed']").removeAttr(
                                        'disabled');
                                    $("#status_order option[value='transaction failed']").attr(
                                        'disabled',
                                        'disabled');
                                    $("#status_order option[value='finished']").attr('disabled',
                                        'disabled');
                                } else if (dataJson['status'] == "delivery") {
                                    $("#status_order option[value='finished']").removeAttr(
                                        'disabled');
                                    $("#status_order option[value='transaction failed']")
                                        .removeAttr(
                                            'disabled');
                                    $("#status_order option[value='unconfirmed']").attr('disabled',
                                        'disabled');
                                    $("#status_order option[value='confirmed']").attr('disabled',
                                        'disabled');
                                } else {
                                    $("#status_order option[value='unconfirmed']").attr('disabled',
                                        'disabled');
                                    $("#status_order option[value='confirmed']").removeAttr(
                                        'disabled');
                                    $("#status_order option[value='transaction failed']").attr(
                                        'disabled',
                                        'disabled');
                    ...
                    $(".denied_order").click(function() {
                        $.ajax({
                            ...
                            url: window.location.origin +
                                '/ProjectSem2/public/ajax/denied-order',
                            data: {
                    ...
                    $(".accept_order").click(function() {
                        $.ajax({
                            ...
                            url: window.location.origin +
                                '/ProjectSem2/public/ajax/accept-order',
                            data: {
                                'id_order': $(this).data('order')
                            },
                            success: function(data) {
                    ...
                    $('.show_chat').click(function() {
                        ...
                        $.ajax({
                            ...
                            url: window.location.origin +
                                '/ProjectSem2/public/ajax/message/show',
                            data: {
