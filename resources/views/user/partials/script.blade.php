<script>
    $(document).ready(function() {
        $('#clearCart').click(function() {
            console.log(window.location.origin + "/ProjectSem2/public/ajax/cart/clearcart");
        ...
        $('.btn_modal').click(function() {
            $.get(window.location.origin + "/ProjectSem2/public/ajax/modal/show-product/" + $(
                this).data('product'), function(data) {
                ...
                if (parseInt(dataProduct["sale"]) > 0) {
                    ...
                    $('#priceAFSModal').html(
                        `$${(parseInt(dataProduct["price"])*(1-dataProduct["sale"]/100)).toFixed(2)}`
                    )
                } else {
        ...
        $('.compare_product').click(function() {
            ...
            $.get(window.location.origin + "/ProjectSem2/public/ajax/add-compare/" + $(this)
                .data('bsProduct'),
                function(data) {
        ...
        $('#show_compare').click(function() {
            $.get(window.location.origin + "/ProjectSem2/public/ajax/compare/showcompare",
                function(data) {
        ...
        $('.addFav').click(function() {
            ...
            $.get(window.location.origin + '/ProjectSem2/public/ajax/add-favourite/' + $(this)
                .data('bsIdproduct'),
                function(data) {
                    $('.countFav').html(data);
                })
        ...
        $('.addToCart').click(function() {
            ...
            toast.show();
            $.get(window.location.origin + "/ProjectSem2/public/ajax/add-cart/" + $(this).data(
                'bsId'), function(data) {
                $('.countCart').html(data);
            });
        });
        ...
        $('.remove_add').click(function() {
            $.get(window.location.origin + "/ProjectSem2/public/ajax/remove_address/" + $(this)
                .data('idadd'),
                function(data) {
        ...
        $('input[name=register_email]').change(function() {
            if (!valiEmail.test($(this).val())) {
                ...
                $.get(window.location.origin + '/ProjectSem2/public/ajax/check-email/' + $(this)
                    .val(),
                    function(data) {
                        if (data == "existed") {
