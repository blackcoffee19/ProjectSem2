      ...
      <div class="container">
        <div class="row">
          ...
          <div class="offset-lg-2 col-lg-8 col-12">
            ...
            @endif
            <form class="row" method="POST" action="{{ route('user.sendMail') }}">
              @csrf
              <!-- input -->
              ...
              <div class="col-md-6 mb-3">
                  ...
                  <input type="email" id="emailContact" name="emailContact" class="form-control" placeholder="Enter Your Email" required>
              </div>
              <div class="col-md-6 mb-3">
                  <!-- input -->
              ...
              <div class="col-md-12 mb-3">
                  ...
                  <textarea rows="3" id="comments" name="comments" class="form-control" placeholder="Additional Comments"></textarea>
              </div>
              <div class="col-md-12">
                  <!-- btn -->
