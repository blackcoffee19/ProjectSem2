                ...
                <div class="col-12">
                    <div>
                        <div class="mb-8">
                            ...
                            @if (!Auth::check())
                                <p class="mb-0">Already have an account? Click here to <a href="#!" class="text-muted"
                                                                    ...
                                                                    <div class="card card-body p-6 " style="height: 240px">
                                                                        <div class="form-check mb-4">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="select_address"
                                                                                data-shipment="{{ $add->shipment_fee }}"
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-2 ">
                                                <div>
                                                    Service Fee <i class="feather-icon icon-info text-muted"
                                                        data-bs-toggle="tooltip" title="Shipment Fee"></i>
                                                </div>
                                                <div class="fw-bold" id="shippment_fee" data-ship="{{ $shipment_fee }}">
                                                    {{ number_format($shipment_fee, 0, '', ' ') }} đ
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between d-none mb-2 "
                                                id="extra_ship">
                                                <div>Extra Shipment fee<i class="feather-icon icon-info text-muted"
                                                        data-bs-toggle="tooltip" title="Shipment Fee"></i>
                                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input[name="select_address"]').change(function() {
                if (parseInt($('input[name="select_address"]:checked').data('shipment')) > parseInt($(
                        "input[name=shipment_fee]").val())) {
                    $('#extra_ship').removeClass('d-none');
                    let totall = parseInt($("#total").data('total')) + parseInt($(
                        'input[name="select_address"]:checked').data('shipment'));
                    $('#total').html(totall + ' đ');
                    $(".totalPay").text((totall * 0.000043).toFixed(2));
                } else if (parseInt($('input[name="select_address"]:checked').data('shipment')) < parseInt(
                        $("input[name=shipment_fee]").val())) {
                    console.log("SECOND");
                ...
                $("input[name=shipment_fee]").val(parseInt($('input[name="select_address"]:checked').data(
                    'shipment')));
            });
                    ...
                    $.get(window.location.origin + "/ProjectSem2/public/ajax/get-address/" + $(
                        ...
                        $("#confirm_paypal").click(function() {
                            window.location.assign(window.location.origin +
                                ...
                                "&instruction=" + $("#DeliveryInstructions").val() +
                                "&shipfee=" + $('input[name=shipment_fee]').val() +
                                "&coupon=" + $('input[name=code_coupon]').val());
                        });
                    })
                @else
            ...
            $("#confirm_paypal").click(function() {
                ...
                .val() + "&address=" + $('input[name=addressReciever]').val() + "&instruction=" + $(
                        "#DeliveryInstructions").val() + "&shipfee=" + $('input[name=shipment_fee]')
                    .val());
            })
        })
    </script>
